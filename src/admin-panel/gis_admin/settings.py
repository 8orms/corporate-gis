...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'gis'),
...
# GeoServer settings
GEOSERVER_VECTOR_URL = os.environ.get('GEOSERVER_VECTOR_URL', 'http://geoserver-vector:8080/geoserver')
GEOSERVER_ECW_URL = os.environ.get('GEOSERVER_ECW_URL', 'http://geoserver-ecw:8080/geoserver')
